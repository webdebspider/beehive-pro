...
const styles = StyleSheet.create({
  ...
  summaryCard: { backgroundColor: T.bgCard, padding: T.spaceMD, borderRadius: T.radiusLG, borderWidth: 1, borderColor: T.border, marginBottom: T.spaceSM },
  summaryLabel: { color: T.textMuted, fontSize: T.fontXS, fontWeight: "800", letterSpacing: 1.5, marginBottom: T.spaceSM },
  summaryText: { color: T.textSecondary, lineHeight: 22, fontSize: T.fontSM },
  copyButton: { backgroundColor: T.green, padding: 14, borderRadius: T.radiusMD, alignItems: "center", marginBottom: T.spaceMD },
  copyText: { color: "#fff", fontWeight: "900", fontSize: T.fontSM },
  sectionLabel: { color: T.textMuted, fontSize: T.fontXS, fontWeight: "800", letterSpacing: 1.5, marginBottom: T.spaceSM },
  shareButton: { backgroundColor: "#4f46e5", padding: 14, borderRadius: T.radiusMD, alignItems: "center", marginBottom: 10 },
  shareText: { color: "#fff", fontWeight: "900", fontSize: T.fontSM },
  shareButtonSecondary: { backgroundColor: T.bgCardAlt, padding: 14, borderRadius: T.radiusMD, alignItems: "center", marginBottom: 10, borderWidth: 1, borderColor: T.border },
